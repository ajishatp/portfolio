                ...
                >
                  {isActive && (
                    <motion.span
                      ...
                      className="absolute inset-0 bg-white/[0.06] border border-white/[0.06] rounded-full"
              ...
              >
                <div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="p-2.5 rounded-xl bg-white/[0.03] border border-white/[0.06] text-purple-400">
                  ...
                  {/* Title */}
                  <h4 className="text-lg font-bold text-white tracking-wide mb-2 group-hover:text-blue-400 transition-colors">
                    {project.title}
                  </h4>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.tags.map((tag) => (
                      <span 
                        key={tag}
                        className="text-[10px] sm:text-xs font-semibold text-slate-300 bg-white/[0.04] border border-white/[0.06] px-2.5 py-0.5 rounded-md"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <div className="flex items-center gap-3 border-t border-white/[0.06] pt-4">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex-1 flex items-center justify-center gap-2 py-2 px-4 rounded-xl border border-white/[0.08] hover:border-white/20 bg-white/[0.02] hover:bg-white/[0.06] text-xs font-semibold text-slate-300 transition-all hover:text-white"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex-1 flex items-center justify-center gap-2 py-2 px-4 rounded-xl bg-blue-600 hover:bg-blue-500 text-xs font-semibold text-white transition-all"
                    >
